...

{
  ...
  while (k <= maxit && error > tol) {
    ...
    //printf("Time required to finish copy computation was %f\n", time_spent);
    ...
    time_spent = (double)(end-begin)/CLOCKS_PER_SEC;
    printf("Time required to finish update computation was %f\n", time_spent);
...
void jacobi_parallel (int n, int m, double dx, double dy, 
             double alpha, double omega, 
             double *u, double *f, 
             double tol, int maxit );
...
int main(int argc, char* argv[]){
    ...
    r1 = omp_get_wtime() - r1;
    printf("Time required to finish initialization computation was %f\n", r1);
    ...
    r1 = omp_get_wtime() - r1;
    printf("Time required to finish error check computation was %f\n", r1);
